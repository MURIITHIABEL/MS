...
$mess = find_by_id('my_text',(int)$_GET['id']);
?>
...
<?php echo display_msg($msg); ?>
   ...
   position: center">
        ...
        <form method="post" action="view_claim.phpid=<?php echo (int)$mess['id']; ?>">
            <p for="name" class="control-label" style="  padding: 0; font-weight: bold; margin-top: 5px;">From:</p>

            <input type="text" class="form-control" name="sender_name" value="<?php echo remove_junk($mess['sender']); ?>" style="
                width: 50%;
                margin-bottom: 10px;
                margin-top: 30px;
                border: none;
            ...
            <input type="text" class="form-control" name="sender_message" value="<?php echo remove_junk($mess['message']); ?>" style="
                width: 100%;
                margin-bottom: 20px;
                margin-top: 1px;
                border: none;
