...
$claim = find_by_id('manager_denied',(int)$_GET['id']);
...
<div style=
     "box-sizing: border-box;width: 900px;height: 1550px;background: #ffffff;
   color: #dc8318;
   top: 5%;
   left: 12%;
    ...
    <div>
        <form method="post" action="manager_view_claim.php?id=<?php echo (int)$claim['id']; ?>">
            ...
            <div style="margin-top: 5px">
                ...
                <span class="label label-danger" ><?php echo "Denied"; ?></span>
        ...
        <button type="none"  name="" class="label label-danger" style="border-radius:20px;
            border: none;
            outline: none;
            height: 40px;
            background: #80000b;
            width: 170px;
            margin-top: 30px;
            margin-left:300px;">Denied!</button>
