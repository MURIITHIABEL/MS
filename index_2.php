...
right: 130px;">
        ...
        <h1 style="padding: 0 0 20px; margin: 0; text-align: center; font-size: 30px">Employee Panel</h1>
        <h4 style="padding: 0 0 30px; margin: 0; text-align: center; font-size: 20px">Claim Management System</h4>

    <form method="post" action="user_login.php" class="clearfix_2">
            <p for="username" class="control-label" style="margin: 0; padding: 0; font-weight: bold;">Employee_id</p>
            <input type="name" class="form-control" name="employee_id" placeholder="Username" style="
            width: 100%;
            margin-bottom: 20px;
            border: none;
